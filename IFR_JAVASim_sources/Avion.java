...
public class Avion {
	 ...
	 * cap en degres;
	 */
	private float assiette, roulis,tauxVirage ,vitesseVerticale, altitude, altitudePA ,vitesse,posX,posY,cap;
	...
	public void updateAvionData(int dT)
	{
		...
		*/
		...
		this.vitesse += this.calculAccelerationTractionMSecSec() / facteurTemps;
		//retire l'acceleration de la trainee
		this.vitesse -= this.calculAccelerationTraineeMSecSec() / facteurTemps;
		
		//Evite que la vitesse ne depasse 250 m/s
		if (this.vitesse > 250) this.vitesse = 250;
	...
	private float calculAccelerationTractionMSecSec()
	{
		...
		tractionN = moteur.calculTractionN(this.vitesse, this.vitesseVerticale, this.atmosphere.getDensiteAir(this.altitude));
	...
	/**
	 * retourne la vitesse de l'avion en m/s
	 * @return
	 */
